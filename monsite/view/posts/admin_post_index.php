...
<a href="<?php echo Router::url('admin/posts/post_edit') ?>" class="btn btn-primary">Ajouter un article</a>
    ...
    <tbody>
        ...
        <?php foreach ($posts as $k => $v) : ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo Router::url('admin/posts/post_edit/id:' . $v->id); ?>">Editer</a>
