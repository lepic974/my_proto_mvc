...
<head>
    ...
    <link href="/Site-Formation/webroot/css/bootstrap.css" rel="stylesheet">
    <link href="/Site-Formation/webroot/css/fontawesome-all.css" rel="stylesheet">
    <link href="/Site-Formation/webroot/css/swiper.css" rel="stylesheet">
	<link href="/Site-Formation/webroot/css/magnific-popup.css" rel="stylesheet">
	<link href="/Site-Formation/webroot/css/styles.css" rel="stylesheet">
	
	<!-- Favicon  -->
    <link rel="icon" href="/Site-Formation/webroot/img/favicon.png">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Scripts -->
    <script src="/Site-Formation/webroot/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="/Site-Formation/webroot/js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="/Site-Formation/webroot/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="/Site-Formation/webroot/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="/Site-Formation/webroot/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="/Site-Formation/webroot/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="/Site-Formation/webroot/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="/Site-Formation/webroot/js/scripts.js"></script> <!-- Custom scripts -->
</body>
</html>